...
import user from "../../../asset/profile.png";
                        ...
                        >
                            ...
                            <div className='flex items-center gap-10 mt-4 flex-wrap w-full'>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Email:</p>
                                    <a href="mailto:user@gmail.com" className='hover:text-primary-green ease-linear duration-200 transition-all'>hernanarevalo16@gmail.com</a>
                                </motion.div>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Phone:</p>
                                    <a href="tel:(+92)123 234567" className='hover:text-primary-green ease-linear duration-200 transition-all'>+54 351 6148912</a>
                                </motion.div>
                                <motion.div variants={statItemVariants} className='flex flex-wrap items-center gap-1 text-secondary-text font-medium text-lg'>
                                    <p>Location:</p>
                                    <p className='hover:text-primary-green ease-linear duration-200 transition-all'>Córdoba, Argentina</p>
                                </motion.div>
                            </div>
                        </motion.div>
                    </div>
